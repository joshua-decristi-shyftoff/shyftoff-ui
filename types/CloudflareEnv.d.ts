/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv types/CloudflareEnv.d.ts` (hash: bb68544503a79cc65bc1b43333de38b8)
...
declare namespace Cloudflare {
	...
	interface Env {
		NEXTJS_ENV: string;
		SHYFTOFF_AGENT_TRAINER_API_URL: string;
