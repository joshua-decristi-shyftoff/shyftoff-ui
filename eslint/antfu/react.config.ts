...
const config: OptionsConfig["react"] = {
  overrides: {
    ...
    "react-refresh/only-export-components": ["error", {
      ...
      allowExportNames: ["dynamic", "dynamicParams", "revalidate", "fetchCache", "runtime", "preferredRegion", "maxDuration", "config", "generateStaticParams", "metadata", "generateMetadata", "viewport", "generateViewport"],
    }],
